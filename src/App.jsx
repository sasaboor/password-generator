...
function App() {
  ...
  return (
    <>
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-700 text-2xl'>
    ...
    <div className='flex text-sm gap-x-2 accent-blue-700'>
